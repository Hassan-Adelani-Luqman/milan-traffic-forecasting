...
TABLES=(
  ...
  final_metrics_area_4159_test.csv final_metrics_area_4159_stress.csv
  final_metrics_area_4556_test.csv final_metrics_area_4556_stress.csv
  final_metrics_area_5161_test.csv final_metrics_area_5161_stress.csv
  timing_test.csv timing_stress.csv
)
PREDICTIONS=(
  test_area_4159.parquet test_area_4556.parquet test_area_5161.parquet
  stress_area_4159.parquet stress_area_4556.parquet stress_area_5161.parquet
)
