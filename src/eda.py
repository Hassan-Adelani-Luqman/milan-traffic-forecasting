...
class SelectedAreas:
    ...
    ``forecast`` is the set Section 4 models: the highest-traffic cell plus the
    two the brief names. Those two are kept regardless of rank precisely because
    they are not the busiest -- comparing across different traffic regimes is
